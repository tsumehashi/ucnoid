#ifndef UCNOID_YAML_DUMPER_C_H
#define UCNOID_YAML_DUMPER_C_H
...
yaml_emitter_dump(yaml_emitter_t *emitter, yaml_document_t *document)
{
    ...
    emitter->anchors = (decltype(emitter->anchors))yaml_malloc(sizeof(*(emitter->anchors))
